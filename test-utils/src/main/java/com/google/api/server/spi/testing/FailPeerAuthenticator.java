...
/**
 * Simple dumb peer authenticator for tests that always fail.
 */
public class FailPeerAuthenticator implements PeerAuthenticator {
  @Override
  ...
  private static Class<? extends PeerAuthenticator>[] makeTestArray() {
    Class<?>[] peerAuthenticators = {FailPeerAuthenticator.class};
