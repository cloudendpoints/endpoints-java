...
public class InvalidParameterAnnotationsException extends ApiParameterConfigInvalidException {
  private static final String ERROR_MESSAGE =
      "Invalid parameter configuration. A parameter in the method path should not have a "
          + "default value or be marked @nullable.";

  public InvalidParameterAnnotationsException(ApiParameterConfig config) {
