 ...
 * @author Eric Orth
 */
public class PropertyParameterNameConflictException extends ApiParameterConfigInvalidException {
  private static final String ERROR_MESSAGE =
      "Parameter name conflicts with a property in the resource.";

  public PropertyParameterNameConflictException(ApiParameterConfig config) {
