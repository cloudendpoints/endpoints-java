...
public final class RpcDescription extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, RpcMethod> methods;
   ...
   */
  public RpcDescription setFeatures(java.util.List<java.lang.String> features) {
   ...
   */
  public RpcDescription setLabels(java.util.List<java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, RpcMethod> getMethods() {
    return methods;
  }
   ...
   */
  public RpcDescription setMethods(java.util.Map<String, RpcMethod> methods) {
   ...
   */
  public RpcDescription setParameters(java.util.Map<String, JsonSchema> parameters) {
   ...
   */
  public RpcDescription setSchemas(java.util.Map<String, JsonSchema> schemas) {
