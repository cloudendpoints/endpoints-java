...
/**
 * An object representing the response of an API call to delete a session.
 */
public class WaxRemoveSessionResponse {
  private String removedSessionId;

  public WaxRemoveSessionResponse() {
  }

  public WaxRemoveSessionResponse(String removedSessionId) {
